if(mouse_check_button_pressed(mb_left)){
	if(position_meeting(device_mouse_x_to_gui(0), device_mouse_y_to_gui(0), id) && global.candyCEnabled == true){
		global.troco = global.coinsOnMachine - 8;
		if(global.troco > 0){
		...
		instance_create_layer(570, 167, "Instances", obj_coke);
